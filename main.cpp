...
int getByte(bool n1, bool n2, bool n3, bool n4, bool n5, bool n6, bool n7, bool n8)
{
...
void Decode()
{
	...
	if (string_BIT.data[0] == 0)	// Если строка пришла в исходном формате
	{
		...
		for (int f = 0; f < OUTPUT.size()-1; f++) { fout << OUTPUT[f]; };
		fout.close();
...
int main(){
    std:: string path = "C:\\IT\\cw\\SOURCE.txt";
